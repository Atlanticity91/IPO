...
public class GameUIScreenLose extends GameUIScreen {
    ...
    public void display(
        ...
        render_manager.drawTextCentered( "Vous avez perdu, appuyer sur espace !", new Vector2( ), new Vector2(Globals.WIN_WIDTH, Globals.WIN_HEIGHT ) );
